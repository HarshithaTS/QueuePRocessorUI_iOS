...
@dynamic deviceID;
@dynamic endTime;
@dynamic inputDataArrayString;
@dynamic objectType;
@dynamic packageName;
@dynamic periority;
@dynamic processCount;
@dynamic processStartTime;
@dynamic queueDate;
@dynamic referenceID;
@dynamic status;
@dynamic subApplication;
@dynamic subApplicationVersion;
@dynamic nextProcessTime;
